...
settings {
  ...
  help = { function() require 'core.filetypes.help' end },
  json = { function() require 'core.filetypes.json' end },
  lua = { function() require 'core.filetypes.lua' end },
  markdown = { function() require 'core.filetypes.markdown' end },
  ['Neogit*'] = {
    wo = { winbar = '' },
  },
  NeogitCommitMessage = {
  ...
  qf = {
    function() require 'core.filetypes.qf' end,
  },
  startuptime = {
  ...
  vim = {
    function() require 'core.filetypes.vim' end,
  },
