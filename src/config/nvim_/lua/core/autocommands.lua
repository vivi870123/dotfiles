...
local function stop_hl()
  ...
  api.nvim_feedkeys(mines.replace_termcodes '<Plug>(StopHL)', 'm', false)
end
...
mines.augroup('VimrcIncSearchHighlight', {
  event = { 'CursorMoved' },
...
mines.augroup('ExternalCommands', {
...
mines.augroup('WindowBehaviours', {
...
mines.augroup('Utilities', {
  ...
  command = function(args)
    ...
    local match = mines.find(function(dir)
...
mines.augroup('TerminalAutocommands', {
  event = { 'TermClose' },
  command = function(args)
